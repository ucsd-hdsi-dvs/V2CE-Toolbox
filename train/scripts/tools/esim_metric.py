...
esim_processed_dir = '/tsukimi/datasets/MVSEC/esim-test-correct'
...
def dataset_metrics(path, results_folder, metrics_dict, metrics_results, n_time_bins=10):
    ...
    f= pickle.load(open(op.join(esim_processed_dir, filename, "events.pkl"),"rb"))
    events_pred = np.column_stack((f['t'],f['x'],f['y'],f['p']))
...
if __name__ == '__main__':    
    ...
    results_folder = op.join('/tsukimi/backup', 'esim-test-metrics-correct')
