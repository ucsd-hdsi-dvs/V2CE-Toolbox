...
from scripts.utils.dl_utils import num_trainable_parameters
...
class UNet(nn.Module):
    def __init__(self, num_input_channels=160, num_output_channels=16,
        ...
        self.head = ConvLayer2D(self.num_input_channels, self.base_num_channels,
    ...
    def build_encoders(self):
        ...
        for input_size, output_size in zip(encoder_input_sizes, encoder_output_sizes):
            encoders.append(ConvLayer2D(input_size, output_size, kernel_size=3,
    ...
    def build_decoders(self):
        ...
        for input_size in decoder_input_sizes:
            ...
            decoders.append(ConvLayer2D(layer_input,
                                      input_size // 2,
...
class UNet3D(nn.Module):
    ...
    def build_encoders(self):
        ...
        encoders = nn.ModuleList()
        for input_size, output_size in zip(encoder_input_sizes, encoder_output_sizes):
            encoders.append(ConvLayer3D(input_size, output_size, kernel_size=3,
                                      stride=(1,2,2), padding=1, norm=self.norm, sn=False))
    ...
    def build_decoders(self):
        ...
        for input_size in decoder_input_sizes:
            ...
            decoders.append(ConvLayer3D(layer_input,
                                      input_size // 2,
                                      kernel_size=3, stride=1, padding=1,
                                      norm=self.norm, sn=self.sn))
            first_layer = False
